...
public class SslSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SslPackage.SET_MODE: {
				SetMode setMode = (SetMode)theEObject;
				T result = caseSetMode(setMode);
				if (result == null) result = caseCondition(setMode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SslPackage.OBSERVE_BINDING: {
				ObserveBinding observeBinding = (ObserveBinding)theEObject;
				T result = caseObserveBinding(observeBinding);
				if (result == null) result = caseObservation(observeBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SslPackage.OBSERVE_DISPLAY: {
				ObserveDisplay observeDisplay = (ObserveDisplay)theEObject;
				T result = caseObserveDisplay(observeDisplay);
				if (result == null) result = caseObservation(observeDisplay);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Observe Binding</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Observe Binding</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseObserveBinding(ObserveBinding object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Observe Display</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Observe Display</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseObserveDisplay(ObserveDisplay object) {
		return null;
	}
