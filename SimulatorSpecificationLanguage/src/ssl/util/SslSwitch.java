...
public class SslSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SslPackage.CHECK_VARIABLE_EQUALS_VARIABLE: {
				CheckVariableEqualsVariable checkVariableEqualsVariable = (CheckVariableEqualsVariable)theEObject;
				T result = caseCheckVariableEqualsVariable(checkVariableEqualsVariable);
				if (result == null) result = caseCondition(checkVariableEqualsVariable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SslPackage.CHECK_VARIABLE_EQUALS_TIME: {
				CheckVariableEqualsTime checkVariableEqualsTime = (CheckVariableEqualsTime)theEObject;
				T result = caseCheckVariableEqualsTime(checkVariableEqualsTime);
				if (result == null) result = caseCondition(checkVariableEqualsTime);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Check Variable Equals Variable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Check Variable Equals Variable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCheckVariableEqualsVariable(CheckVariableEqualsVariable object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Check Variable Equals Time</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Check Variable Equals Time</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCheckVariableEqualsTime(CheckVariableEqualsTime object) {
		return null;
	}
