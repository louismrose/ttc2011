...
public class SslAdapterFactory extends AdapterFactoryImpl {
	...
	protected SslSwitch<Adapter> modelSwitch =
		new SslSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCheckVariableEqualsVariable(CheckVariableEqualsVariable object) {
				return createCheckVariableEqualsVariableAdapter();
			}
			@Override
			public Adapter caseCheckVariableEqualsTime(CheckVariableEqualsTime object) {
				return createCheckVariableEqualsTimeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ssl.CheckVariableEqualsVariable <em>Check Variable Equals Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCheckVariableEqualsVariableAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ssl.CheckVariableEqualsTime <em>Check Variable Equals Time</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCheckVariableEqualsTimeAdapter() {
		return null;
	}
