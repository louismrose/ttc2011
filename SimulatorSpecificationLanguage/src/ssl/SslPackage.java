...
public interface SslPackage extends EPackage {
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see ssl.impl.CheckTimePastOtherImpl
   * @see ssl.impl.SslPackageImpl#getCheckTimePastOther()
   * @generated
   */
   ...
   * @ordered
   */
  int CHECK_TIME_PAST_OTHER__FIRST_VARIABLE_NAME = CONDITION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int CHECK_TIME_PAST_OTHER__SECOND_VARIABLE_NAME = CONDITION_FEATURE_COUNT + 1;

  /**
   * The number of structural features of the '<em>Check Time Past Other</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int CHECK_TIME_PAST_OTHER_FEATURE_COUNT = CONDITION_FEATURE_COUNT + 2;
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Check Time Past Other</em>'.
   * @see ssl.CheckTimePastOther
   * @generated
   */
  EClass getCheckTimePastOther();

  /**
   * Returns the meta object for the attribute '{@link ssl.CheckTimePastOther#getFirstVariableName <em>First Variable Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>First Variable Name</em>'.
   * @see ssl.CheckTimePastOther#getFirstVariableName()
   * @see #getCheckTimePastOther()
   * @generated
   */
  EAttribute getCheckTimePastOther_FirstVariableName();

  /**
   * Returns the meta object for the attribute '{@link ssl.CheckTimePastOther#getSecondVariableName <em>Second Variable Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Second Variable Name</em>'.
   * @see ssl.CheckTimePastOther#getSecondVariableName()
   * @see #getCheckTimePastOther()
   * @generated
   */
  EAttribute getCheckTimePastOther_SecondVariableName();
   ...
   */
     ...
     * @generated
     */
    EClass CHECK_TIME_PAST_OTHER = eINSTANCE.getCheckTimePastOther();
     ...
     * @generated
     */
    EAttribute CHECK_TIME_PAST_OTHER__FIRST_VARIABLE_NAME = eINSTANCE.getCheckTimePastOther_FirstVariableName();
     ...
     * @generated
     */
    EAttribute CHECK_TIME_PAST_OTHER__SECOND_VARIABLE_NAME = eINSTANCE.getCheckTimePastOther_SecondVariableName();
