 ...
 * <ul>
 *   <li>{@link ssl.ObserveLabelValue#getLabelType <em>Label Type</em>}</li>
 ...
 * @generated
 */
public interface ObserveLabelValue extends Observation
{
  /**
   ...
   * @see ssl.SslPackage#getObserveLabelValue_LabelType()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link ssl.ObserveLabelValue#getLabelType <em>Label Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
