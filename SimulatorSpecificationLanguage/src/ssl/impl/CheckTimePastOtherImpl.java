...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Check Time Past Other</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link ssl.impl.CheckTimePastOtherImpl#getFirstVariableName <em>First Variable Name</em>}</li>
 *   <li>{@link ssl.impl.CheckTimePastOtherImpl#getSecondVariableName <em>Second Variable Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CheckTimePastOtherImpl extends ConditionImpl implements CheckTimePastOther
{
  /**
   ...
   * @generated
   */
  protected CheckTimePastOtherImpl()
  {
    super();
  }
  ...
  {
    return SslPackage.Literals.CHECK_TIME_PAST_OTHER;
  }
  ...
  public void setFirstVariableName(String newFirstVariableName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SslPackage.CHECK_TIME_PAST_OTHER__FIRST_VARIABLE_NAME, oldFirstVariableName, firstVariableName));
  }
  ...
  public void setSecondVariableName(String newSecondVariableName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SslPackage.CHECK_TIME_PAST_OTHER__SECOND_VARIABLE_NAME, oldSecondVariableName, secondVariableName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SslPackage.CHECK_TIME_PAST_OTHER__FIRST_VARIABLE_NAME:
        return getFirstVariableName();
      case SslPackage.CHECK_TIME_PAST_OTHER__SECOND_VARIABLE_NAME:
