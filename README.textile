...
# OnOff: The simplest watch, which demonstrates modes, entry actions and buttons. "Specification":https://github.com/louismrose/ttc2011/raw/master/WatchSpecifications/ssl/OnOff.xmi "Configuration Reference Solution":https://github.com/louismrose/ttc2011/raw/master/WatchSpecifications/scl/OnOff.xmi
# SetTime: Introduces variables, the alarm, and conditional actions. "Specification":https://github.com/louismrose/ttc2011/raw/master/WatchSpecifications/ssl/SetTime.xmi "Configuration Reference Solution":https://github.com/louismrose/ttc2011/raw/master/WatchSpecifications/scl/SetTime.xmi
# Alarm: A combination of the two previous watches. "Specification":https://github.com/louismrose/ttc2011/raw/master/WatchSpecifications/ssl/Alarm.xmi "Configuration Reference Solution":https://github.com/louismrose/ttc2011/raw/master/WatchSpecifications/scl/Alarm.xmi
...
Tip: the "inconsistent watch specifications":https://github.com/louismrose/ttc2011/tree/master/WatchSpecifications/ssl/inconsistent directory provide examples of testcases that will probably fail (depending on how the transformation for the core task has been implemented).  

h2. Evaluation Criteria

Solutions will be evaluated, and a winner announced in each of the following categories:

* Core task (SSL to SCL)
* Extension 1 (Robustness)
* Extension 2 (Matching)
* Overall

Participants might like to consider the following criteria when assessing the solutions:

* Clarity: the ease with which the solution can be understood due to, for example, the expressiveness of the code.
* Conciseness: the number of modules, rules, etc. used in the solution
* Architecture: the modularity / abstraction of the solution.