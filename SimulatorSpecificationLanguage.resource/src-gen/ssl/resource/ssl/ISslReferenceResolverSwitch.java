...
/**
 * A ISslReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface ISslReferenceResolverSwitch extends ssl.resource.ssl.ISslConfigurable {
