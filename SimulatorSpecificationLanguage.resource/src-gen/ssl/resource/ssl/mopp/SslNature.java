...
public class SslNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "SimulatorSpecificationLanguage.resource.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {ssl.resource.ssl.mopp.SslBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(ssl.resource.ssl.mopp.SslBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
