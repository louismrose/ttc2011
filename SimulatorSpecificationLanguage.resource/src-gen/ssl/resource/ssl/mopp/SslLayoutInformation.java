...
public class SslLayoutInformation {
	
	private final ssl.resource.ssl.grammar.SslSyntaxElement syntaxElement;
	...
	public SslLayoutInformation(ssl.resource.ssl.grammar.SslSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public ssl.resource.ssl.grammar.SslSyntaxElement getSyntaxElement() {
