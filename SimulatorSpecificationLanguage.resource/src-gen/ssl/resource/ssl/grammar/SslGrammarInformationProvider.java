...
public class SslGrammarInformationProvider {
	...
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_8_0_0_1 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getPressButton().getEStructuralFeature(ssl.SslPackage.PRESS_BUTTON__BUTTON), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_8_0_0_2 = new ssl.resource.ssl.grammar.SslKeyword(" button is pressed", ssl.resource.ssl.grammar.SslCardinality.ONE);
	...
	public final static Rule SSL_8 = new Rule(ssl.SslPackage.eINSTANCE.getPressButton(), SSL_8_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_9_0_0_0 = new ssl.resource.ssl.grammar.SslKeyword("the watch must be in mode \"", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_9_0_0_1 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveMode().getEStructuralFeature(ssl.SslPackage.OBSERVE_MODE__MODE), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	...
	public final static Rule SSL_9 = new Rule(ssl.SslPackage.eINSTANCE.getObserveMode(), SSL_9_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	...
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_10_0_0_1 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveButton().getEStructuralFeature(ssl.SslPackage.OBSERVE_BUTTON__BUTTON), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_10_0_0_2 = new ssl.resource.ssl.grammar.SslKeyword(" button must be called \"", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_10_0_0_3 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveButton().getEStructuralFeature(ssl.SslPackage.OBSERVE_BUTTON__NAME), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_10_0_0_4 = new ssl.resource.ssl.grammar.SslKeyword("\"", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslSequence SSL_10_0_0 = new ssl.resource.ssl.grammar.SslSequence(ssl.resource.ssl.grammar.SslCardinality.ONE, SSL_10_0_0_0, SSL_10_0_0_1, SSL_10_0_0_2, SSL_10_0_0_3, SSL_10_0_0_4);
	...
	public final static Rule SSL_10 = new Rule(ssl.SslPackage.eINSTANCE.getObserveButton(), SSL_10_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	...
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_11_0_0_1 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveLabelValue().getEStructuralFeature(ssl.SslPackage.OBSERVE_LABEL_VALUE__LABEL_TYPE), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_11_0_0_2 = new ssl.resource.ssl.grammar.SslKeyword("\" must show \"", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_11_0_0_3 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveLabelValue().getEStructuralFeature(ssl.SslPackage.OBSERVE_LABEL_VALUE__VALUE), "TEXT", ssl.resource.ssl.grammar.SslCardinality.QUESTIONMARK, 0);
	...
	public final static Rule SSL_11 = new Rule(ssl.SslPackage.eINSTANCE.getObserveLabelValue(), SSL_11_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	...
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_12_0_0_1 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveLabelVariable().getEStructuralFeature(ssl.SslPackage.OBSERVE_LABEL_VARIABLE__LABEL_TYPE), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_12_0_0_2 = new ssl.resource.ssl.grammar.SslKeyword("\" must show the ", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_12_0_0_3 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveLabelVariable().getEStructuralFeature(ssl.SslPackage.OBSERVE_LABEL_VARIABLE__VARIABLE_NAME), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslSequence SSL_12_0_0 = new ssl.resource.ssl.grammar.SslSequence(ssl.resource.ssl.grammar.SslCardinality.ONE, SSL_12_0_0_0, SSL_12_0_0_1, SSL_12_0_0_2, SSL_12_0_0_3);
	...
	public final static Rule SSL_12 = new Rule(ssl.SslPackage.eINSTANCE.getObserveLabelVariable(), SSL_12_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_13_0_0_0 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveVariableChange().getEStructuralFeature(ssl.SslPackage.OBSERVE_VARIABLE_CHANGE__VARIABLE_NAME), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_13_0_0_1 = new ssl.resource.ssl.grammar.SslKeyword(" must be incremented by 1 ", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_13_0_0_2 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveVariableChange().getEStructuralFeature(ssl.SslPackage.OBSERVE_VARIABLE_CHANGE__UNIT), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslSequence SSL_13_0_0 = new ssl.resource.ssl.grammar.SslSequence(ssl.resource.ssl.grammar.SslCardinality.ONE, SSL_13_0_0_0, SSL_13_0_0_1, SSL_13_0_0_2);
	...
	public final static Rule SSL_13 = new Rule(ssl.SslPackage.eINSTANCE.getObserveVariableChange(), SSL_13_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_14_0_0_0 = new ssl.resource.ssl.grammar.SslKeyword("the alarm must ring", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslSequence SSL_14_0_0 = new ssl.resource.ssl.grammar.SslSequence(ssl.resource.ssl.grammar.SslCardinality.ONE, SSL_14_0_0_0);
	...
	public final static Rule SSL_14 = new Rule(ssl.SslPackage.eINSTANCE.getObserveRing(), SSL_14_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
}
