...
public class SslGrammarInformationProvider {
	...
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_7_0_0_0 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getCheckVariableEqualsVariable().getEStructuralFeature(ssl.SslPackage.CHECK_VARIABLE_EQUALS_VARIABLE__FIRST_VARIABLE_NAME), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_7_0_0_1 = new ssl.resource.ssl.grammar.SslKeyword(" is equal to ", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_7_0_0_2 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getCheckVariableEqualsVariable().getEStructuralFeature(ssl.SslPackage.CHECK_VARIABLE_EQUALS_VARIABLE__SECOND_VARIABLE_NAME), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	...
	public final static Rule SSL_7 = new Rule(ssl.SslPackage.eINSTANCE.getCheckVariableEqualsVariable(), SSL_7_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_8_0_0_0 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getCheckVariableEqualsTime().getEStructuralFeature(ssl.SslPackage.CHECK_VARIABLE_EQUALS_TIME__FIRST_VARIABLE_NAME), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_8_0_0_1 = new ssl.resource.ssl.grammar.SslKeyword(" is equal to time ", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_8_0_0_2 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getCheckVariableEqualsTime().getEStructuralFeature(ssl.SslPackage.CHECK_VARIABLE_EQUALS_TIME__TIME), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	...
	public final static Rule SSL_8 = new Rule(ssl.SslPackage.eINSTANCE.getCheckVariableEqualsTime(), SSL_8_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_9_0_0_0 = new ssl.resource.ssl.grammar.SslKeyword("the watch enters mode \"", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_9_0_0_1 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getEntersMode().getEStructuralFeature(ssl.SslPackage.ENTERS_MODE__MODE), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	...
	public final static Rule SSL_9 = new Rule(ssl.SslPackage.eINSTANCE.getEntersMode(), SSL_9_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_10_0_0_0 = new ssl.resource.ssl.grammar.SslKeyword("the ", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_10_0_0_1 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getPressButton().getEStructuralFeature(ssl.SslPackage.PRESS_BUTTON__BUTTON), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_10_0_0_2 = new ssl.resource.ssl.grammar.SslKeyword(" button is pressed", ssl.resource.ssl.grammar.SslCardinality.ONE);
	...
	public final static Rule SSL_10 = new Rule(ssl.SslPackage.eINSTANCE.getPressButton(), SSL_10_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_11_0_0_0 = new ssl.resource.ssl.grammar.SslKeyword("the watch must be in mode \"", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_11_0_0_1 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveMode().getEStructuralFeature(ssl.SslPackage.OBSERVE_MODE__MODE), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_11_0_0_2 = new ssl.resource.ssl.grammar.SslKeyword("\"", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslSequence SSL_11_0_0 = new ssl.resource.ssl.grammar.SslSequence(ssl.resource.ssl.grammar.SslCardinality.ONE, SSL_11_0_0_0, SSL_11_0_0_1, SSL_11_0_0_2);
	...
	public final static Rule SSL_11 = new Rule(ssl.SslPackage.eINSTANCE.getObserveMode(), SSL_11_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	...
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_12_0_0_1 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveButton().getEStructuralFeature(ssl.SslPackage.OBSERVE_BUTTON__BUTTON), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_12_0_0_2 = new ssl.resource.ssl.grammar.SslKeyword(" button must be called \"", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_12_0_0_3 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveButton().getEStructuralFeature(ssl.SslPackage.OBSERVE_BUTTON__NAME), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	...
	public final static Rule SSL_12 = new Rule(ssl.SslPackage.eINSTANCE.getObserveButton(), SSL_12_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	...
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_13_0_0_1 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveLabelValue().getEStructuralFeature(ssl.SslPackage.OBSERVE_LABEL_VALUE__LABEL_TYPE), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_13_0_0_2 = new ssl.resource.ssl.grammar.SslKeyword("\" must show \"", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_13_0_0_3 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveLabelValue().getEStructuralFeature(ssl.SslPackage.OBSERVE_LABEL_VALUE__VALUE), "TEXT", ssl.resource.ssl.grammar.SslCardinality.QUESTIONMARK, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_13_0_0_4 = new ssl.resource.ssl.grammar.SslKeyword("\"", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslSequence SSL_13_0_0 = new ssl.resource.ssl.grammar.SslSequence(ssl.resource.ssl.grammar.SslCardinality.ONE, SSL_13_0_0_0, SSL_13_0_0_1, SSL_13_0_0_2, SSL_13_0_0_3, SSL_13_0_0_4);
	...
	public final static Rule SSL_13 = new Rule(ssl.SslPackage.eINSTANCE.getObserveLabelValue(), SSL_13_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_14_0_0_0 = new ssl.resource.ssl.grammar.SslKeyword("the \"", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_14_0_0_1 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveLabelVariable().getEStructuralFeature(ssl.SslPackage.OBSERVE_LABEL_VARIABLE__LABEL_TYPE), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_14_0_0_2 = new ssl.resource.ssl.grammar.SslKeyword("\" must show the ", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_14_0_0_3 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveLabelVariable().getEStructuralFeature(ssl.SslPackage.OBSERVE_LABEL_VARIABLE__VARIABLE_NAME), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslSequence SSL_14_0_0 = new ssl.resource.ssl.grammar.SslSequence(ssl.resource.ssl.grammar.SslCardinality.ONE, SSL_14_0_0_0, SSL_14_0_0_1, SSL_14_0_0_2, SSL_14_0_0_3);
	...
	public final static Rule SSL_14 = new Rule(ssl.SslPackage.eINSTANCE.getObserveLabelVariable(), SSL_14_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_15_0_0_0 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveVariableChange().getEStructuralFeature(ssl.SslPackage.OBSERVE_VARIABLE_CHANGE__VARIABLE_NAME), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_15_0_0_1 = new ssl.resource.ssl.grammar.SslKeyword(" must be incremented by 1 ", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslPlaceholder SSL_15_0_0_2 = new ssl.resource.ssl.grammar.SslPlaceholder(ssl.SslPackage.eINSTANCE.getObserveVariableChange().getEStructuralFeature(ssl.SslPackage.OBSERVE_VARIABLE_CHANGE__UNIT), "TEXT", ssl.resource.ssl.grammar.SslCardinality.ONE, 0);
	public final static ssl.resource.ssl.grammar.SslSequence SSL_15_0_0 = new ssl.resource.ssl.grammar.SslSequence(ssl.resource.ssl.grammar.SslCardinality.ONE, SSL_15_0_0_0, SSL_15_0_0_1, SSL_15_0_0_2);
	...
	public final static Rule SSL_15 = new Rule(ssl.SslPackage.eINSTANCE.getObserveVariableChange(), SSL_15_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslKeyword SSL_16_0_0_0 = new ssl.resource.ssl.grammar.SslKeyword("the alarm must ring", ssl.resource.ssl.grammar.SslCardinality.ONE);
	public final static ssl.resource.ssl.grammar.SslSequence SSL_16_0_0 = new ssl.resource.ssl.grammar.SslSequence(ssl.resource.ssl.grammar.SslCardinality.ONE, SSL_16_0_0_0);
	public final static ssl.resource.ssl.grammar.SslChoice SSL_16_0 = new ssl.resource.ssl.grammar.SslChoice(ssl.resource.ssl.grammar.SslCardinality.ONE, SSL_16_0_0);
	public final static Rule SSL_16 = new Rule(ssl.SslPackage.eINSTANCE.getObserveRing(), SSL_16_0, ssl.resource.ssl.grammar.SslCardinality.ONE);
}
