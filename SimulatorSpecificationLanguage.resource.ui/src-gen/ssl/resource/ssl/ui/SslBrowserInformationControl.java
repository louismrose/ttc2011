 ...
 * @since 3.2
 */
public class SslBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private ssl.resource.ssl.ui.SslDocBrowserInformationControlInput fInput;
	 ...
	 */
	public SslBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public SslBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public SslBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof ssl.resource.ssl.ui.SslDocBrowserInformationControlInput);
		...
		fInput= (ssl.resource.ssl.ui.SslDocBrowserInformationControlInput) input;
		...
		ssl.resource.ssl.ui.SslHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = ssl.resource.ssl.ui.SslHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public ssl.resource.ssl.ui.SslDocBrowserInformationControlInput getInput() {
		return fInput;
	}
