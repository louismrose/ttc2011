 ...
 */
public class SslPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(ssl.resource.ssl.ui.SslUIPlugin.getDefault().getPreferenceStore());
		setDescription(" Ssl Text Editor Preferences");
	}
