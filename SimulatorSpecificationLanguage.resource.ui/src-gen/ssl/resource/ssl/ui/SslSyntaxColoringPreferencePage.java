 ...
 */
public class SslSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = ssl.resource.ssl.ui.SslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ssl.resource.ssl.ui.SslSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = ssl.resource.ssl.ui.SslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ssl.resource.ssl.ui.SslSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = ssl.resource.ssl.ui.SslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ssl.resource.ssl.ui.SslSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = ssl.resource.ssl.ui.SslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ssl.resource.ssl.ui.SslSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = ssl.resource.ssl.ui.SslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ssl.resource.ssl.ui.SslSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = ssl.resource.ssl.ui.SslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ssl.resource.ssl.ui.SslSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		ssl.resource.ssl.ui.SslPixelConverter pixelConverter = new ssl.resource.ssl.ui.SslPixelConverter(composite);
	...
	public SslSyntaxColoringPreferencePage() {
		super();
		
		ssl.resource.ssl.ISslMetaInformation syntaxPlugin = new ssl.resource.ssl.mopp.SslMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof ssl.resource.ssl.ui.SslEditor) {
			ssl.resource.ssl.ui.SslEditor emfTextEditor = (ssl.resource.ssl.ui.SslEditor) editor;
