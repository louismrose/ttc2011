 ...
 */
public class SslHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public SslHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof ssl.resource.ssl.ui.SslEditor) {
					ssl.resource.ssl.ui.SslEditor emftEditor = (ssl.resource.ssl.ui.SslEditor) editorPart;
