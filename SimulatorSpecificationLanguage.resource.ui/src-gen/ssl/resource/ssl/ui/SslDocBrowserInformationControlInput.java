 ...
 * olInput</code>.
 */
public class SslDocBrowserInformationControlInput {
	
	private final SslDocBrowserInformationControlInput fPrevious;
	private SslDocBrowserInformationControlInput fNext;
	 ...
	 */
	public SslDocBrowserInformationControlInput(SslDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public SslDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public SslDocBrowserInformationControlInput getNext() {
		return fNext;
	}
