 ...
 */
public class SslCodeFoldingManager {
	
	private class FoldingUpdateListener implements ssl.resource.ssl.ISslBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(ssl.resource.ssl.ui.SslEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof ssl.resource.ssl.ui.SslEditor) {
				ssl.resource.ssl.ui.SslEditor editor = (ssl.resource.ssl.ui.SslEditor) workbenchPart;
	...
	protected ssl.resource.ssl.ui.SslEditor editor;
	 ...
	 */
	public SslCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,ssl.resource.ssl.ui.SslEditor textEditor) {
	...
	private void addCloseListener(final ssl.resource.ssl.ui.SslEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			ssl.resource.ssl.ui.SslUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		ssl.resource.ssl.ISslTextResource textResource = (ssl.resource.ssl.ISslTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
