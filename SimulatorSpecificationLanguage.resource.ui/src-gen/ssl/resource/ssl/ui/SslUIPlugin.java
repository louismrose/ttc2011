 ...
 */
public class SslUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "SimulatorSpecificationLanguage.resource.ui";
	...
	private static SslUIPlugin plugin;
	...
	public static SslUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SslUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SslUIPlugin.PLUGIN_ID, message);
		}
		final SslUIPlugin pluginInstance = SslUIPlugin.getDefault();
