...
public class SslPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof ssl.resource.ssl.ui.SslEObjectSelection) {
			final ssl.resource.ssl.ui.SslEObjectSelection selection = (ssl.resource.ssl.ui.SslEObjectSelection) iSelection;
