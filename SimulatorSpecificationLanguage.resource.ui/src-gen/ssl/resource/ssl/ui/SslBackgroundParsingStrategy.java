 ...
 */
public class SslBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final ssl.resource.ssl.ISslTextResource resource, final ssl.resource.ssl.ui.SslEditor editor) {
		if (resource == null) {
			return;
		}
