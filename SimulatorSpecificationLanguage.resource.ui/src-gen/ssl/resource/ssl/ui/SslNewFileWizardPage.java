 ...
 */
public class SslNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public SslNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new ssl file");
