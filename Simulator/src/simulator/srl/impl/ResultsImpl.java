 ...
 * <ul>
 *   <li>{@link simulator.srl.impl.ResultsImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResultsImpl extends EObjectImpl implements Results {
	 ...
	 * @ordered
	 */
	protected EList<SimulationElement> elements;
	...
	public EList<SimulationElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<SimulationElement>(SimulationElement.class, this, ResultsPackage.RESULTS__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ResultsPackage.RESULTS__ELEMENTS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResultsPackage.RESULTS__ELEMENTS:
				getElements().clear();
				getElements().addAll((Collection<? extends SimulationElement>)newValue);
				return;
		}
