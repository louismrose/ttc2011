 ...
 * <ul>
 *   <li>{@link simulator.scl.AndCondition#getSubconditions <em>Subconditions</em>}</li>
 * </ul>
 * </p>
 *
 * @see simulator.scl.ConfigPackage#getAndCondition()
 * @model
 * @generated
 */
public interface AndCondition extends Condition {
	 ...
	 * @see simulator.scl.ConfigPackage#getAndCondition_Subconditions()
