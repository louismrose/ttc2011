 ...
 * <ul>
 *   <li>{@link simulator.scl.NotCondition#getSubcondition <em>Subcondition</em>}</li>
 * </ul>
 * </p>
 *
 * @see simulator.scl.ConfigPackage#getNotCondition()
 * @model
 * @generated
 */
public interface NotCondition extends Condition {
	 ...
	 * @see simulator.scl.ConfigPackage#getNotCondition_Subcondition()
	...
	/**
	 * Sets the value of the '{@link simulator.scl.NotCondition#getSubcondition <em>Subcondition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
