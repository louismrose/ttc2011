 ...
 * <ul>
 *   <li>{@link simulator.scl.Button#getName <em>Name</em>}</li>
 *   <li>{@link simulator.scl.Button#getBehaviour <em>Behaviour</em>}</li>
 * </ul>
 * </p>
 *
 * @see simulator.scl.ConfigPackage#getButton()
 * @model
 * @generated
 */
public interface Button extends EObject {
	 ...
	 * @see #setName(String)
	 * @see simulator.scl.ConfigPackage#getButton_Name()
	 * @model required="true"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link simulator.scl.Button#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see simulator.scl.ConfigPackage#getButton_Behaviour()
