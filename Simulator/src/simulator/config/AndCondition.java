 ...
 * <ul>
 *   <li>{@link simulator.config.AndCondition#getSubconditions <em>Subconditions</em>}</li>
 * </ul>
 * </p>
 *
 * @see simulator.config.ConfigPackage#getAndCondition()
 * @model
 * @generated
 */
public interface AndCondition extends Condition {
	 ...
	 * @see simulator.config.ConfigPackage#getAndCondition_Subconditions()
