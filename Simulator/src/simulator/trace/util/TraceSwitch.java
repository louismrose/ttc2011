 ...
 * <!-- end-user-doc -->
 * @see simulator.trace.TracePackage
 * @generated
 */
public class TraceSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TracePackage.STIMULUS: {
				Stimulus stimulus = (Stimulus)theEObject;
				T result = caseStimulus(stimulus);
				if (result == null) result = caseTraceElement(stimulus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case TracePackage.ENVIRONMENTAL_CHANGE: {
				...
				if (result == null) result = caseTraceElement(environmentalChange);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
